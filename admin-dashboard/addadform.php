...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Add Admission</h4>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($fname != "" && $lname != "" && $address != "" && $dob != "" && $phone_number != "" && $email != "" && $gender != "" && $course != "") {
                ...
                $insert_query = "INSERT INTO admission_form (fname,lname,address,dob,phone_number,email,gender,course) VALUES ('$fname', '$lname', '$address','$dob','$phone_number','$email','$gender','$course')";
                        ...
                        <form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Enter Your Contact Number" aria-describedby="helpId">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Email</label>
                                    <input type="email" name="email" id="email" class="form-control" placeholder="@gmail.com" aria-describedby="helpId">
                                </div>
                                <div class="form-group col-md-6">
