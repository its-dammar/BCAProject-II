...
<main class="ttr-wrapper">
	<div class="container-fluid">
		...
		<button class="btn-primary mb-2 mr-1 px-2 rounded" onClick="window.location.href='adduser.php';"><i class="fa fa-plus"></i></button>
		...
		?>
			...
			?>
				<div class="alert alert-warning alert-dismissible fade show" role="alert">
					...
					<strong>User is not deleted successfully.</strong>
				</div>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a class="btn btn-primary btn-sm" href="edituser.php?id=<?php echo $data_select['id']; ?>">Edit</a>
										<a class="btn-secondry"onclick="return checkDelete()" href="deleteprocess/deleteuser.php?id=<?php echo $data_select['id']; ?>">Delete</a>
									</td>
								</tr>
							<?php
							}
