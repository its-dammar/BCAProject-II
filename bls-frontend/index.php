...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item" data-bs-interval="3000">
                <img src="assets/uploads/4.jpg" class="d-block w-100" alt="..." />
                <div class="carousel-caption d-none d-md-block">
                    <h5>Third slide label</h5>
                    <p>Some representative placeholder content for the third slide.</p>
                </div>
    ...
    <section class="pt-5 bg-light">
        <div class="container">
            ...
            <div class="row text-center pt-3 pb-5">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 container mb-5 mb-md-0">
                    <div class="d-flex justify-content-center mb-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 container mb-0">
                    <div class="d-flex justify-content-center mb-4">
    ...
    <section class="pt-5">
        <div class="container">
            ...
            <div class="row text-center pt-3 pb-5">
                <div class="col-lg-3 shadow-sm col-md-4 col-sm-6 mb-5 mb-md-0">
                    <div class="d-flex justify-content-center mb-4">
                        <img class="gallery-image" src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(1).webp" class="thumbani shadow-1-strong" width="100%" height="300" />
                    </div>
                    <h5 class="mb-3">Kathamandu</h5>
                    <h6 class="text-primary mb-3">Web Developer</h6>
                </div>
                <div class="col-lg-3 shadow-sm col-md-4 col-sm-6 container mb-5 mb-md-0">
                    <div class="d-flex justify-content-center mb-4">
                        <img class="gallery-image" src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(2).webp" class="thumbani shadow-1-strong" width="100%" height="300" />
                    </div>
                    <h5 class="mb-3">Chitwan</h5>
                    <h6 class="text-primary mb-3">Graphic Designer</h6>
                </div>
                <div class="col-lg-3 shadow-sm col-md-4 col-sm-6 container mb-0">
                    <div class="d-flex justify-content-center mb-4">
                        <img class="gallery-image" src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(9).webp" class="thumbani shadow-1-strong" width="100%" height="300" />
                    </div>
                    <h5 class="mb-3">Pokhara, Kaski</h5>
                    <h6 class="text-primary mb-3">Marketing Specialist</h6>
                </div>
                <div class="col-lg-3 shadow-sm col-md-4 col-sm-6 container mb-0">
                    <div class="d-flex justify-content-center mb-4">
            ...
            <div class="more-btn pb-5 text-center">
                <a href="gallery.html" class="btn btn-secondary">More..</a>
            </div>
        </div>
    </section>
    <!-- gallery section -->
    ...
    <section class="bg-secondary">
        <div class="container map  pt-4 pb-4">
