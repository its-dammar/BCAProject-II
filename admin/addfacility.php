...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Add Facility</h4>
        ...
        <button class="btn-primary mb-2 mr-1 px-2 rounded" onClick="window.location.href='managefacility.php';"><i class="fa fa-list-alt"></i> | Manage</button>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($title != "" && $content != "" && $img != "") {
                $query = "INSERT INTO  facilities(title, content, img) VALUES ('$title', '$content',  '$img')";
        ...
        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <strong>Facility is added successfully.</strong>
                    </div>
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>Facility couldn't be added successfully.</strong>
                    </div>
        <?php
                }
            } else {
