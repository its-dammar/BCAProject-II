...
<main class="ttr-wrapper">
	<div class="container-fluid">
		<div class="db-breadcrumb">
			<h4 class="breadcrumb-title">Add Site Config</h4>
			<ul class="db-breadcrumb-list">
				<li><a href="#"><i class="fa fa-home"></i>Home</a></li>
				<li>Add Site Config</li>
			</ul>
		</div>
		<?php
		if (isset($_POST['submit'])) {
			...
			if ($slider_img != "" && $phone != "" && $email != "" && $google_link != "" && $google_link != "" && $linkedin_link != "" && $heading != "" && $logo != "" && $favicon != "" && $home_bg != "") {

				$insert_query = "INSERT INTO siteconfig (slider_img, phone,email,fb_link,google_link,linkedin_link, heading, logo, favicon, home_bg) VALUES ('$slider_img' , '$phone' , '$email', '$fb_link', '$google_link', '$linkedin_link', '$heading', '$logo','$favicon', '$home_bg')";
				$insert_result = mysqli_query($conn, $insert_query);
				if ($insert_result) {
		?>
					<meta http-equiv="refresh" content="0,url=managesiteconfig.php?msg=asiteconfigsuccess">

		<?php
				} else {
					echo "Site Config couldn't be added.";
				}
			} else {
					...
					<div class="widget-inner">
						<form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="input-group mb-3 col-12">
									<input id="imagebox" type="text" class="form-control" name="logo" readonly>
									<div class="input-group-append">
										<button type="button" class="btn-primary" data-toggle="modal" data-target="#modelId2">Choose Image
										</button>
									</div>
								...
								<div class="input-group mb-3 col-12">
									<input id="iconbox" type="text" class="form-control" name="favicon" readonly>
									<div class="input-group-append">
								...
								<div class="input-group mb-3 col-12">
									<input id="bgbox" type="text" class="form-control" name="home_bg" readonly>
									<div class="input-group-append">
