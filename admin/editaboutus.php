...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Edit About Us</h4>
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $show_query = "SELECT * FROM about_us WHERE id=$id";
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($slider_img != "" && $title1 != "" && $text1 != "" && $img != "" && $title2 != "" && $text2 != "") {
                $query = "UPDATE about_us SET slider_img = '$slider_img', title1 ='$title1', text1='$text1', img = '$img', title2 ='$title2', text2='$text2' WHERE id=$id";
        ...
        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <strong>About Us is updated successfully.</strong>
                    </div>
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>About Us couldn't be updated successfully.</strong>
                    </div>
        <?php
                }
            }
                                ...
                                <form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="input-group mb-3 col-12">
                                            <input id="sliderbox" type="text" class="form-control" name="slider_img" value="<?php echo $show_row['slider_img']; ?>">
