...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Add Home</h4>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($slider1 != "" && $slider2 != "" && $title1 != "" && $text1 != "" && $title2 != "" && $text2 != "" && $btn_link != "" && $title3 != "" && $title4 != "") {
                $query = "INSERT INTO home(slider1, slider2, title1, text1, title2, text2, btn_link, title3, title4) VALUES ('$slider1', '$slider2', '$title1', '$text1', '$title2', '$text2', '$btn_link', '$title3', '$title4')";
        ...
        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <strong>Index is added successfully.</strong>
                    </div>
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>Index couldn't be added successfully.</strong>
                    </div>
        <?php
                }
            } else {
                        ...
                        <form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="input-group mb-3 col-12">
                                    <input id="sliderbox1" type="text" class="form-control" name="slider1" readonly>
                                ...
                                <div class="input-group mb-3 col-12">
                                    <input id="sliderbox2" type="text" class="form-control" name="slider2" readonly>
                                    <div class="input-group-append">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <input class="form-control" type="text" name="btn_link">
                                    </div>
                                </div>
