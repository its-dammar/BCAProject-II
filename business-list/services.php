        ...
        <div class="container px-lg-5">
            <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                <div class="m-4 m-lg-5">
                    ...
                    <p class="fs-4">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, voluptatum eaque. Quasi consequuntur voluptatem velit praesentium? Dolore qui nulla a!
                    </p>
                    <a class="btn btn-primary btn-lg" href="#!">Get Services</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="pt-4">
        <div class="container px-lg-5">
            ...
            <div class="row gx-lg-5">
                <div class="our-services col-lg-4 col-md-4 col-sm-6 mb-5">
