...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Add New File</h4>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($filesize <= 2000000) {
                if ($extention == 'pdf' || $extention == 'txt' || $extention == 'docx' || $extention == 'xsl') {
                    if (move_uploaded_file($_FILES['dataFile']['tmp_name'], "../files/" . $finalfile)) {
                        $query = "INSERT INTO newmanager(name,filelink) VALUES ('$fname','$finalfile')";
        ...
        ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                <strong>New File is added successfully.</strong>
                            </div>
                        ...
                        ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <strong>File couldn't be added successfully.</strong>
                            </div>
        <?php
                        }
                    } else {
