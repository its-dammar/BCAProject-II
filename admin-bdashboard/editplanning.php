...
<main class="ttr-wrapper">
    <div class="container-fluid">
        <div class="db-breadcrumb">
            <h4 class="breadcrumb-title">Edit Planning</h4>
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $show_query = "SELECT * FROM planning WHERE id=$id";
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($slider_img != "" && $title != "" && $text != "" && $img != "") {
                $query = "UPDATE planning SET slider_img = '$slider_img', title ='$title', text='$text', img = '$img' WHERE id=$id";
        ...
        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <strong>Planning is updated successfully.</strong>
                    </div>
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>Planning couldn't be updated successfully.</strong>
                    </div>
        <?php
                }
            }
