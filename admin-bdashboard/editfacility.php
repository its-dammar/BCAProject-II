...
<main class="ttr-wrapper">
    <div class="container-fluid">
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $show_query = "SELECT * FROM facilities WHERE id=$id";
            ...
            <div class="container-fluid">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($title != "" && $content != "" && $img != "") {
                        $query = "UPDATE facilities SET title ='$title', content='$content', img = '$img' WHERE id=$id";
                ...
                ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                <strong>Facility is updated successfully.</strong>
                            </div>
                        ...
                        ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <strong>Facility couldn't be updated successfully.</strong>
                            </div>
                <?php
                        }
                    } else {
                                ...
                                <form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <div>
                                                <input class="form-control" type="title" value="<?php echo $show_row['title']; ?>" name="title">
                                            </div>
                                        </div>
                                        <div class="form-group col-12">
