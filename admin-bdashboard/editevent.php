	...
	<div class="container-fluid">
		...
		if (isset($_POST['submit'])) {
			...
			if ($title != "" && $content != "" && $img != "" && $eventDate != "" && $venue != "") {
				...
				$update_query = "UPDATE events SET title='$title', content='$content', img='$img', eventDate='$eventDate', venue='$venue' WHERE id=$id";
				$update_result = mysqli_query($conn, $update_query);
				if ($update_result) {
		?>
					<meta http-equiv="refresh" content="0,url=manageevent.php?msg=updateeventsuccess">

		<?php
				} else {
					echo "Event couldn't be updated.";
				}
			} else {
						...
						<form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="form-group col-12">
									...
									<div>
										<textarea class="form-control" name="content" cols="30" rows="10"><?php echo $select_row['content']; ?></textarea>
									</div>
								</div>
								...
								<div class="input-group mb-5 col-12">
									<input id="imagebox" type="text" class="form-control" name="img" value="<?php echo $select_row['img'] ?>" readonly>
								...
								<div class="form-group col-md-6">
									...
									<input type="date" name="eventDate" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $select_row['eventDate'] ?>">
								</div>

								<div class="form-group col-12">
									<label class="col-form-label">Venue</label>
									<div>
										<input class="form-control" type="text" name="venue" value="<?php echo $select_row['venue'] ?>">
									</div>
								</div>
