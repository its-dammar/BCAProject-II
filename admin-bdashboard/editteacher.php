...
<main class="ttr-wrapper">
	<div class="container-fluid">
		...
		if (isset($_POST['submit'])) {
			...
			if ($name != "" && $subject != "" && $img != "") {
				$query = "UPDATE teachers SET name='$name', subject='$subject', img='$img' WHERE id=$id";
		...
		?>
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						...
						<strong>Teacher is updated successfully.</strong>
					</div>
				...
				?>
					<div class="alert alert-danger alert-dismissible fade show" role="alert">
						...
						<strong>Teacher couldn't be updated successfully.</strong>
					</div>
		<?php
				}
			} else {
						...
						<form class="edit-profile m-b30" form action="#" method="POST" enctype="multipart/form-data">
							<div class="row">
								<div class="form-group col-12">
									...
									<div>
										<input class="form-control" value="<?php echo $show_row['slider_img']; ?>" type="text" name="name">
									</div>
								</div>
								<div class="form-group col-12">
									<label class="col-form-label">Name</label>
									<div>
										<input class="form-control" value="<?php echo $show_row['name']; ?>" type="text" name="name">
									</div>
								</div>
								<div class="form-group col-12">
									<label class="col-form-label">Subject</label>
									<div>
										<input class="form-control" value="<?php echo $show_row['subject']; ?>" type="subject" name="subject">
									</div>
								</div>
